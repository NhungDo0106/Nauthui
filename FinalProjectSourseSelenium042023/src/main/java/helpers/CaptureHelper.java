...
public class CaptureHelper extends ScreenRecorder {
    ...
    // Start record video
    public static void startRecord(String videoName) {
        ...
        try {
            screenRecorder = new CaptureHelper(gc, captureSize, new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI), new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE, CompressorNameKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE, DepthKey, 24, FrameRateKey, Rational.valueOf(15), QualityKey, 1.0f, KeyFrameIntervalKey, 15 * 60), new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, "black", FrameRateKey, Rational.valueOf(30)), null, file, videoName);
...
//            LogUtils.info("Take screenshot " + ScreenShotName + " successfully");
//        } catch (IOException e) {
//            //throw new RuntimeException(e);
//            LogUtils.info("ERROR. Can not Take screenshot " + ScreenShotName + " ");
//        }
//
//    }
}
